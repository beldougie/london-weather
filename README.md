...
Instructions here are defined for a local deployment only. The approach used easily allows for adaptation to a production environment.
...
A test script is provided by create-react-app, but no tests have been wired up directly for this project.
